...
# COMMAND ----------
 ...
 -- create or replace global temporary view age_stos_rates as
 select
...
# COMMAND ----------
 ...
 -- create or replace global temporary view adult_cyp_stos_rates as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 -- create or replace global temporary view all_age_stos_rates as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
