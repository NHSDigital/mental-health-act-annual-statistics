...
# COMMAND ----------
 ...
 -- create or replace global temporary view age_discharges_rates as
 select
...
# COMMAND ----------
 ...
 -- create or replace global temporary view adult_cyp_discharges_rates as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 -- create or replace global temporary view all_age_discharges_rates as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
