...
# COMMAND ----------
 ...
 -- create or replace global temporary view age_ctos_rates as
 select
...
# COMMAND ----------
 ...
 -- create or replace global temporary view adult_cyp_ctos_rates as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 -- create or replace global temporary view  as
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
