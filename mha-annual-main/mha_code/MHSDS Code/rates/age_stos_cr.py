...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view age_stos as
 ---get short term orders count at lower age bands
 select 
 case 
...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view adult_cyp_stos as
 ---get short term orders count at higher age bands
 select 
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.age_stos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.age_stos_rates AS
 ---combine short term orders and population count and calculate crude rate at lower age band
 select
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.adult_cyp_stos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.adult_cyp_stos_rates AS
 ---combine short term orders and population count and calculate crude rate at higher age band
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.all_age_stos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.all_age_stos_rates AS
 ---combine short term orders and population count and calculate crude rate at age total
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
