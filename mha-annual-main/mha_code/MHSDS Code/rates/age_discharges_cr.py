# Databricks notebook source
 ...
 ---get population count for lower age bands
 select 
 CASE
...
# COMMAND ----------
 ...
 ---get population count for higher age bands
 select
 CASE
...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view age_discharges as
 ---get discharges following detention count at lower age bands
 select 
 case 
...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view adult_cyp_discharges as
 ---get discharges following detention count at higher age bands
 select 
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.age_discharges_rates;
 CREATE TABLE IF NOT EXISTS $db_output.age_discharges_rates AS
 ---combine discharges following detention and population count and calculate crude rate at lower age band
 select
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.adult_cyp_discharges_rates;
 CREATE TABLE IF NOT EXISTS $db_output.adult_cyp_discharges_rates AS
 ---combine discharges following detention and population count and calculate crude rate at higher age band
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.all_age_discharges_rates;
 CREATE TABLE IF NOT EXISTS $db_output.all_age_discharges_rates AS
 ---combine discharges following detention and population count and calculate crude rate at age total
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
