# Databricks notebook source
 ...
 where 
 Der_gender in ('1','2')
 and ethnic_group_formatted in ('White','Mixed','Asian or Asian British','Black or Black British','Other Ethnic Groups')									
...
# COMMAND ----------
 ...
 ---get detentions count at lower ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
 distinct
 CASE 
...
# COMMAND ----------
 ...
 ---combine detentions and population count and calculate crude rate at lower ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
...
# COMMAND ----------
 ...
 ---join detentions count, population, standardised rate and confidnce interval at lower ethnicity
 select
 a.Ethnicity,
...
# COMMAND ----------
 ...
 ---get detentions count at higher ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
 distinct
 CASE
...
# COMMAND ----------
 ...
 ---combine community treatment orders and population count and calculate crude rate at lower ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
 a.ethnic_group_formatted as Ethnicity,
 a.Der_gender,
 a.age_group,
...
# COMMAND ----------
 ...
 ---join detentions count, population, standardised rate and confidence interval at higher ethnicity
 select
 a.Ethnicity,
 sum(c.count) as count,
 sum(c.population) as population,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.eth_detentions_rates;
 CREATE TABLE IF NOT EXISTS $db_output.eth_detentions_rates AS
 ---combine all detentions figures for lower ethnicity, higher ethnicity and ethnicity total
