...
# COMMAND ----------
 ...
 ---get detentions count at lower age bands
 select 
 case 
...
# COMMAND ----------
 ...
 ---get detentions count at higher age bands
 select 
...
# COMMAND ----------
 ...
 ---combine detentions and population count and calculate crude rate at lower age band
 select
...
# COMMAND ----------
 ...
 ---combine detentions and population count and calculate crude rate at higher age band
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 ---combine detentions and population count and calculate crude rate at age total
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
