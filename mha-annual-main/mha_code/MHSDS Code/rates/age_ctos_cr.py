...
# COMMAND ----------
 ...
 ---get population count at higher age bands
 select
 CASE
...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view age_ctos as
 ---get community treatment order count at lower age bands
 select 
 case 
...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view adult_cyp_ctos as
 ---get community treatment order count at higher age bands
 select 
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.age_ctos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.age_ctos_rates AS
 ---combine community treatment order and population count and calculate crude rate at lower age band
 select
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.adult_cyp_ctos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.adult_cyp_ctos_rates AS
 ---combine community treatment order and population count and calculate crude rate at higher age band
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.all_age_ctos_rates;
 CREATE TABLE IF NOT EXISTS $db_output.all_age_ctos_rates AS
 ---combine community treatment order and population count and calculate crude rate at age total
 select
 "Age" as demographic_breakdown,
 "All" as organisation_breakdown,
