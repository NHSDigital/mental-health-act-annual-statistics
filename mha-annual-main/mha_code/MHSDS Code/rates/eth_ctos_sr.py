...
# COMMAND ----------
 ...
 from $db_output.POP_HEALTH
 WHERE Der_Gender in ('1','2')
 and ethnic_group_formatted not in ('White','Mixed','Asian or Asian British','Black or Black British','Other Ethnic Groups') ---avoids over counting
 GROUP BY 
 ethnic_group_formatted,
 Ethnic_group,
 Der_Gender,
...
# COMMAND ----------
 ...
 ---get community treatment orders count at lower ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
 distinct
 CASE 
 ...
 FROM $db_output.CTO
 WHERE EthnicCategory is not NULL and EthnicCategory not in ('Z','99')
...
# COMMAND ----------
 ...
 ---join community treatment orders count, population, standardised rate and confidnce interval at lower ethnicity
 select
 a.Ethnicity,
...
# COMMAND ----------
 ...
 ---get community treatment orders count at higher ethnicity, gender and lower age groups where all demographic values are known and valid
 select 
 distinct
 CASE
...
# COMMAND ----------
 ...
 ---join community treatment orders count, population, standardised rate and confidnce interval at higher ethnicity
 select
 a.Ethnicity,
 sum(c.count) as count,
 sum(c.population) as population,
...
# COMMAND ----------
 ...
 ---combine all community treatment orders figures for lower ethnicity, higher ethnicity and ethnicity total
