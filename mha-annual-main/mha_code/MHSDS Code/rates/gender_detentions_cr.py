...
# COMMAND ----------
 ...
 %sql
 create or replace temporary view gender_detentions as
 ---get detentions count at gender
 select 
 Der_Gender,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.gender_detentions_rates;
 CREATE TABLE IF NOT EXISTS $db_output.gender_detentions_rates AS
 ---combine detentions and population count and calculate crude rate at gender
 select
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.all_gender_detentions_rates;
 CREATE TABLE IF NOT EXISTS $db_output.all_gender_detentions_rates AS
 ---combine detentions and population count and calculate crude rate at gender total
 select
 "Gender" as demographic_breakdown,
 "All" as organisation_breakdown,
