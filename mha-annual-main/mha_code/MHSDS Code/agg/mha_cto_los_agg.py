# Databricks notebook source
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---national all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 ...
 FROM $db_output.mha_los_quartiles_cto

# COMMAND ----------

 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, national all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, national all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---gender all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, gender all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, gender all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---age band all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, age band all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, age band all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---higher ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, higher ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, higher ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---lower ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, lower ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, lower ethnicity all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---deprivation all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, deprivation all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 INSERT INTO $db_output.mha_cto_los
 ---mha category, mha description, deprivation all detentions and community treatment orders in days (n, lower quartile, median and upper quartile)
 SELECT 
 'England' as Geography,
 'England' as OrgCode,
 'England' as OrgName,
...
# COMMAND ----------
 ...
 %sql
 DROP TABLE IF EXISTS $db_output.mha_cto_los_lookup; 
 CREATE TABLE $db_output.mha_cto_los_lookup as
...
# COMMAND ----------
 ...
 FROM $db_output.mha_cto_los_lookup L
 LEFT JOIN $db_output.mha_cto_los A 
